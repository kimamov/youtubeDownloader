...
const FormatSelect = (props) => {
  return (
    <form onSubmit={props.onSubmit} className={'typeSelect'}>
        ...
        <input id='quickTypeSelect1' onChange={props.onChange} checked={props.quickType==="0"} value="0" name='quickType' type='radio'></input>
            <label htmlFor='quickTypeSelect1'>HD VIDEO</label>
            <input id='quickTypeSelect2' onChange={props.onChange} checked={props.quickType==="1"} value="1" name='quickType' type='radio'></input>
            <label htmlFor='quickTypeSelect2'>BEST AUDIO</label>
            <input id='quickTypeSelect3' onChange={props.onChange} checked={props.quickType==="2"} value="2" name='quickType' type='radio'></input>
